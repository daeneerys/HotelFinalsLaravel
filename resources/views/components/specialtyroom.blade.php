<h3 class="font-poppins font-bold text-lg tracking-widest">Specialty Suite Rooms</h3>
<p class="font-inter text-sm mt-2">Experience the extraordinary in our Specialty Suites.
    From private plunge pools overlooking the jungle canopy to breathtaking views of cascading waterfalls,
    these unique retreats offer an unforgettable escape.
</p>
